...
public final class Guomi_Interface_test_sm2SignTest_jmhTest {
    ...
    public BenchmarkTaskResult sm2SignTest_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_guomi_interface_test0_0.sm2SignTest());
                res.allOps++;
            }

            sm2SignTest_thrpt_jmhStub(control, res, l_guomi_interface_test0_0, l_blackhole1_1);
    ...
    public void sm2SignTest_thrpt_jmhStub(InfraControl control, RawResults result, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult sm2SignTest_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            sm2SignTest_avgt_jmhStub(control, res, l_guomi_interface_test0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_guomi_interface_test0_0.sm2SignTest());
    ...
    public void sm2SignTest_avgt_jmhStub(InfraControl control, RawResults result, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult sm2SignTest_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            sm2SignTest_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_guomi_interface_test0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_guomi_interface_test0_0.sm2SignTest());
    ...
    public void sm2SignTest_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult sm2SignTest_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            sm2SignTest_ss_jmhStub(control, batchSize, res, l_guomi_interface_test0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void sm2SignTest_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
