...
public final class Guomi_Interface_test_sm4DecCBCTest_jmhTest {
    ...
    public BenchmarkTaskResult sm4DecCBCTest_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_guomi_interface_test0_0.sm4DecCBCTest();
                res.allOps++;
            }

            sm4DecCBCTest_thrpt_jmhStub(control, res, l_guomi_interface_test0_0, l_blackhole1_1);
    ...
    public void sm4DecCBCTest_thrpt_jmhStub(InfraControl control, RawResults result, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult sm4DecCBCTest_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            sm4DecCBCTest_avgt_jmhStub(control, res, l_guomi_interface_test0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_guomi_interface_test0_0.sm4DecCBCTest();
    ...
    public void sm4DecCBCTest_avgt_jmhStub(InfraControl control, RawResults result, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult sm4DecCBCTest_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            sm4DecCBCTest_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_guomi_interface_test0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_guomi_interface_test0_0.sm4DecCBCTest();
    ...
    public void sm4DecCBCTest_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult sm4DecCBCTest_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            sm4DecCBCTest_ss_jmhStub(control, batchSize, res, l_guomi_interface_test0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void sm4DecCBCTest_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Guomi_Interface_test_jmhType l_guomi_interface_test0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
